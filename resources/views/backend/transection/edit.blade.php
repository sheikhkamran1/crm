                                ...
                                <select id="customer_id" class="form-control" name="customer_id">
                                    @foreach ($customers as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $customer->id ? 'selected' : '' }}>{{ $item->name }} -
                                ...
                                <div class="card-body">
                                    <form action="{{ route('transection.update', $customer->id) }}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="year">For the Year eg(1 for first year, 2 for second
                                                        year)</label>
                                        ...
                                        <button type="submit" class="brn btn-primary">Update Record</button>
                                    </form>
                                </div>
